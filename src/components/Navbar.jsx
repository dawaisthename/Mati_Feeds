...
const Navbar = () => {
  ...
  return (
    <nav
      className={`bg-[#F5F7FA] sticky top-0 border-gray-200 z-50 dark:bg-gray-900 ${
    ...
    >
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        {/* Hamburger Icon */}
        <button
          onClick={() => setToggleMenu(!toggleMenu)} // Toggle menu visibility on click
          type="button"
        ...
        <div
          className={`${
            toggleMenu ? "block" : "hidden" // Show or hide the mobile menu based on toggleMenu state
