    ...
    <section className="bg-gradient-to-r from-[#A8EC0E] to-white py-20 px-6 sm:px-8 lg:px-16 text-gray-900">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 lg:gap-20">
          <div className="relative group p-6 bg-white rounded-xl shadow-xl overflow-hidden hover:bg-[#A8EC0E] transition-all duration-300">
            <img
            ...
            />
            <h3 className="text-xl font-semibold text-[#A8EC0E] group-hover:text-white mb-2">
              Rigorous Testing
            </h3>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#A8EC0E] to-transparent opacity-20 group-hover:opacity-30 transition-opacity duration-300"></div>
          </div>
